...
def is_valid(s):
    ...
    #plate should start with 2 letters, if it doesn't return false     there can be '12____' or 'A1____'
    if (not s[0].isalpha() and not s[1].isalpha()) or (s[0].isalpha() and not s[1].isalpha()):
        return False
